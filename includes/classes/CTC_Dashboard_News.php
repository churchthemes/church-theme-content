...
if ( ! class_exists( 'CTC_Dashboard_News' ) ) {
	...
	class CTC_Dashboard_News {
		...
		public function dashboard_items_count() {
			...
			/**
			 * Apply the filter ctc_dashboard_news_count for letting an admin
			 * override this count.
			 */
			return (int) apply_filters( 'ctc_dashboard_news_count', self::FEED_COUNT );
		}
