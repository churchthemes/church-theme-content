 ...
 * @version 1.6.14
 */
class CTC_EDD_SL_Plugin_Updater
{
    ...
    private function api_request($_action, $_data)
    {
        ...
        */
        ...
        $request = wp_remote_post($remote_api_url, [
            'body' => [
                'edd_action' => 'get_version',
                'license'    => ! empty($data['license']) ? $data['license'] : '',
                'item_name'  => isset($data['item_name']) ? $data['item_name'] : false,
    ...
    public function show_changelog()
    {
        ...
        if (! current_user_can('update_plugins')) {
            wp_die(__('You do not have permission to install plugin updates', 'church-theme-content'), __('Error', 'church-theme-content'), array('response' => 403));
        }
    ...
    {
        return (bool) apply_filters('edd_sl_api_request_verify_ssl', true, $this); // could be made false for local self-signed SSL
    }
}
